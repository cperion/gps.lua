...
assert(Point.__ref_class_id ~= nil)
assert(Coord.__ref_class_id ~= nil)
assert(LineString.__ref_class_id ~= nil)
assert(Ring.__ref_class_id ~= nil)
assert(Polygon.__ref_class_id ~= nil)
...
assert(l.__slot ~= nil)
assert(g.__slot ~= nil)
assert(Coord(1, 2).__slot == Coord(1, 2).__slot)

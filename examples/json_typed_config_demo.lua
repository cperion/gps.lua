...
local decode_config, decode_phase = typed.decoder("json_demo_config_decode", spec, function(obj)
...
local value = json.parse_string('{"name":"alpha","mode":"fast"}')
local cfg1 = decode_config(value)
local cfg2 = decode_config(value)

print(cfg1)
print(cfg1 == cfg2)
print(pvm.report_string({ json.policy_decode.phase, decode_phase }))

...
local mtMaxPx = classof(T.Layout.MaxPx(0))
...
local function node_box(node)
    while node do
        ...
        elseif kind == "Overlay" then
            node = node.base
        elseif kind == "Flex" or kind == "Grid" or kind == "Pad" or kind == "Stack" or kind == "Clip"
            or kind == "Transform" or kind == "ScrollArea"
            or kind == "Panel" or kind == "Rect" or kind == "Text" or kind == "RuntimeText"

...
T:Define [[
    ...
    module DemoView {
        TransportButton = (string id, string label) unique
    ...
    module DemoLive {
        ...
        Window = (
            DemoLive.Texts texts,
            DemoLive.Arrangement arrangement,
            DemoLive.Devices devices
        )
    }

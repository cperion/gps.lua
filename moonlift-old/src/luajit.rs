...
unsafe extern "C" {
    ...
    fn lua_pushvalue(state: *mut lua_State, idx: c_int);
...
impl LuaState {
    ...
    pub unsafe fn push_value(state: *mut lua_State, idx: c_int) {
    ...
    pub unsafe fn pcall(state: *mut lua_State, nargs: c_int, nresults: c_int) -> c_int {
        unsafe { lua_pcall(state, nargs, nresults, 0) }
    }
